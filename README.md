...
В планах интергировать платежную систему Stripe, автоматически создавать pdf-файл заказа и отсылать его пользователю, добавить поиск по категориям и товарам,
