...
# @pytest.mark.django_db
# def test_order_created_email_content(test_product, test_user):
#     """Проверяет, что функция order_created формирует правильное сообщение email."""
#     order = Order.objects.create(
#         user=test_user,
#         full_name='Ronaldo',
#         email='test@gmail.com',
...
#     # Мокируем функцию send_mail
#     with patch('orders.tasks.send_mail') as mock_send_mail:
#         # Вызываем order_created.delay с order.id
#         order_created.delay(order.id)
